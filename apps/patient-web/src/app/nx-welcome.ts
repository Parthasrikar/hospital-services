      ...
      <div class="container">
        ...
        <div id="middle-left-content">
          <div id="learning-materials" class="rounded shadow">
            ...
            <a href="https://nx.dev/getting-started/tutorials/angular-standalone-tutorial?utm_source=nx-project" target="_blank" rel="noreferrer" class="list-item-link">
              <svg
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
...
nx run-many -t build test lint</pre>
          ...
          <details>
            ...
            <pre>nx show project patient-web</pre>
          </details>
